...
export default function Home({ onExplore, darkMode }) {
  return (
    <section className={`p-2 m-4 ${darkMode ? "bg-gray-900 text-gray-100" : "bg-yellow-200 text-black"} rouned-md shadow-md`}>
      <h1 className="font-cormorant text-5xl my-4 text-center">
      ...
      <div className="w-screen flex flex-row items-center justify-center">
        <img
          ...
          className={`rounded-md w-[240px] h-[240px] m-4 shadow-border-box-sm mt-4 mb-8 hover:shadow-sm ease-linear duration-300 ${darkMode ? "border-gray-600" : "border-stone-500"
            } border-2`}
        />
        <div className="ml-4">
      ...
      <div className="mx-8">
        ...
        <p className="font-cormorant text-xl text-center">
          ...
          <button
            className={`p-3 border-2 my-4 rounded-xl ${darkMode
              ? "bg-gray-700 text-gray-200 hover:bg-gray-600 hover:text-white border-gray-500"
              : "bg-orange-100 border-stone-500 hover:bg-stone-600 hover:text-white"
              } ease-in-out duration-300 translate-x-3`}
            onClick={() => {
              onExplore("Artwork");
            }}
          >
